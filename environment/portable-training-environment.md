# Training environment using the portable setup

These instructions describes apply when the portable environment using physical hardware is used to provide student VMs during a local training session.
