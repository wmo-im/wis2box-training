...
В этой сессии вы научитесь находить данные из WIS2 Global Discovery Catalogue (GDC) с помощью [pywiscat](https://github.com/wmo-im/pywiscat), инструмента командной строки для поиска и извлечения метаданных из WIS2 GDC.
