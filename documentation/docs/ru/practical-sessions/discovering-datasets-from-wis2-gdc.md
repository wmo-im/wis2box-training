...
В этой сессии вы узнаете, как находить данные в WIS2 Global Discovery Catalogue (GDC) с помощью [pywiscat](https://github.com/wmo-im/pywiscat), инструмента командной строки для поиска и извлечения метаданных из WIS2 GDC.
...
!!! note
    Перед началом работы, пожалуйста, войдите в вашу виртуальную машину (VM) для студентов.
...
??? success "Нажмите, чтобы увидеть ответ"
    Количество записей зависит от GDC, к которому вы обращаетесь. При использовании локального тренировочного GDC вы должны увидеть, что количество записей равно количеству наборов данных, загруженных в GDC во время других практических сессий.
