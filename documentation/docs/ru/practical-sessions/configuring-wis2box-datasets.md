...
Смотрите раздел [Инициализация wis2box](/practical-sessions/initializing-wis2box), если вам нужно вспомнить, как подключиться к брокеру или получить доступ к wis2box-webapp.
