...
Перейдите в только что созданный каталог, нажмите "Upload" и выберите [sample-data-for-universal-plugin](../sample-data/Z_NAFP_C_BABJ_20250818000000_P_CMA-GEPS-GLB-024.grib2), который вы скачали на свой локальный компьютер ранее.
