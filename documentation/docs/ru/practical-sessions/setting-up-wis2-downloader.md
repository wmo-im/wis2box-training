...
Вы можете ознакомиться с разбором переменных окружения в [разделе 2.1 Руководства администратора WIS2 Downloader](https://world-meteorological-organization.github.io/wis2downloader/en/admin-guide.html)
