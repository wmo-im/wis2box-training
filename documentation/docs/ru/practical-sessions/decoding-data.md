...
Этот контейнер запустит сервер Jupyter-ноутбуков на вашей виртуальной машине, который включает библиотеку [ecCodes](https://sites.ecmwf.int/docs/eccodes), которую можно использовать для декодирования данных BUFR.
...
- [Panoply](https://www.giss.nasa.gov/tools/panoply/) — кроссплатформенное приложение для построения графиков географически привязанных и других массивов из NetCDF, HDF, GRIB и других наборов данных
...
- [Integrated Data Viewer (IDV)](https://www.unidata.ucar.edu/software/idv/) — бесплатная программная платформа на базе Java для анализа и визуализации геонаучных данных, включая поддержку форматов GRIB и NetCDF
