...
!!! note
    ...
    Если вы хотите пройти это обучение вне локальной учебной сессии, вы можете создать собственную виртуальную машину, используя любого облачного провайдера, например:
