---
title: Доступ к вашей студенческой виртуальной машине (VM)
---

# Доступ к вашей студенческой виртуальной машине (VM)

!!! abstract "Результаты обучения"

    К концу этой практической сессии вы сможете:

    - получить доступ к своей студенческой виртуальной машине через SSH и WinSCP
...
В рамках локальных семинаров по обучению WIS2 вы можете получить доступ к своей персональной студенческой виртуальной машине в локальной учебной сети под названием "WIS2-training".
...
Подключите ваш ПК к локальной сети Wi-Fi, раздаваемой в аудитории во время обучения WIS2, согласно инструкциям, предоставленным тренером.
...
Чтобы проверить, что ваш пользователь может запускать Docker, выполните следующую команду:
```bash
...
Если на вашем локальном ПК установлен WinSCP, вы можете использовать его для подключения к вашей студенческой виртуальной машине, чтобы просмотреть содержимое домашнего каталога, а также загружать или выгружать файлы между вашей виртуальной машиной и локальным ПК. 
...
!!! success "Поздравляем!"
    ...
    - получать доступ к своей студенческой виртуальной машине через SSH и WinSCP
