...
В рамках локального семинара по обучению WIS2 вы можете получить доступ к вашей персональной учебной виртуальной машине в локальной учебной сети под названием "WIS2-training".
...
Подключите ваш ПК к локальной сети Wi-Fi, раздаваемой в помещении во время обучения WIS2, следуя инструкциям, предоставленным тренером.
...
WinSCP не обязателен для обучения, но может быть полезен, если вы хотите редактировать файлы на вашей виртуальной машине с помощью текстового редактора на локальном ПК.
