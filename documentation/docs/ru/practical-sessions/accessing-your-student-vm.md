...
В рамках локально проводимых тренингов WIS2 вы можете получить доступ к вашей персональной учебной виртуальной машине в локальной сети обучения под названием "WIS2-training".
...
!!! note
    ...
    Если вы хотите пройти это обучение вне локальной сессии, вы можете создать собственный экземпляр виртуальной машины, используя любого облачного провайдера, например:
    ...
    Если вы используете учебную виртуальную машину, предоставленную во время локальных тренингов WIS2, необходимое программное обеспечение уже будет установлено.

## Подключение к вашей учебной виртуальной машине в локальной сети обучения

Подключите ваш ПК к локальной сети Wi-Fi, раздаваемой в помещении во время тренинга WIS2, согласно инструкциям, предоставленным тренером.
