...
!!! abstract "Результаты обучения"
    ...
    - удостовериться, что у вас есть доступ к материалам для упражнений на вашей локальной учебной виртуальной машине

## Введение

В рамках локальных семинаров по обучению WIS2 вы можете получить доступ к вашей персональной учебной виртуальной машине в локальной обучающей сети под названием "WIS2-training".
...
!!! note
    ...
    Если вы хотите пройти это обучение вне локальной сессии, вы можете использовать собственный экземпляр, предоставленный любым облачным провайдером, например:
    ...
    Для выполнения материалов упражнений потребуются следующие дополнительные пакеты Python:
...
## Подключение к вашей учебной виртуальной машине в локальной обучающей сети
...
Для проверки, что ваш пользователь может запускать команды Docker, выполните следующую команду:
```bash
...
!!! success "Поздравляем!"
    ...
    - подключаться к вашей учебной виртуальной машине через SSH и WinSCP
    - проверять наличие установленного программного обеспечения, необходимого для выполнения практических упражнений
    - удостоверяться, что у вас есть доступ к материалам для упражнений на вашей локальной учебной виртуальной машине