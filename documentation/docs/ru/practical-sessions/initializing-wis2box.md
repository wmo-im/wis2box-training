...
Тома, начинающиеся с `wis2box_project_`, используются для хранения постоянных данных для различных сервисов программного стека wis2box.
...
Это главная страница API wis2box (запущенного через контейнер **wis2box-api**).
...
Откройте MQTT Explorer на вашем компьютере и подготовьте новое подключение для подключения к вашему брокеру (запущенному через контейнер **wis2box-broker**).
