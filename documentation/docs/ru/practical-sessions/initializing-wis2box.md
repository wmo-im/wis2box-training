...
Далее вас попросят указать URL для вашего wis2box. Этот URL будет использоваться для доступа к веб-приложению, API и интерфейсу wis2box.
...
Обратите внимание, что после входа ваш приглашение командной строки изменится, указывая, что вы находитесь внутри контейнера wis2box-management:
...
В wis2box есть API (интерфейс прикладного программирования), который предоставляет доступ к данным и процессы для интерактивной визуализации, преобразования данных и их публикации.
...
После входа переместите курсор мыши к меню слева, чтобы увидеть доступные опции в веб-приложении wis2box:
