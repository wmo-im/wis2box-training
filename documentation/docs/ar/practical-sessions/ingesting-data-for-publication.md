...
ادخل إلى الدليل الذي تم إنشاؤه حديثًا، وانقر على "Upload"، وحدد [sample-data-for-universal-plugin](../sample-data/Z_NAFP_C_BABJ_20250818000000_P_CMA-GEPS-GLB-024.grib2) الذي قمت بتنزيله إلى جهازك المحلي مسبقًا.
