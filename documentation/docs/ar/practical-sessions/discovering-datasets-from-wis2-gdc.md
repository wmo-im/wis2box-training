...
خلال جلسات التدريب المحلية، يتم إعداد كتالوج عالمي محلي للاكتشاف (GDC) للسماح للمشاركين بالاستعلام عن GDC للحصول على البيانات الوصفية التي قاموا بنشرها من مثيلات wis2box الخاصة بهم. في هذه الحالة، سيقوم المدربون بتوفير عنوان URL الخاص بـ GDC المحلي.

## التحضير

!!! note
    قبل البدء، يرجى تسجيل الدخول إلى الجهاز الافتراضي الخاص بك كطالب.
...
!!! note "تغيير عنوان URL الخاص بـ GDC"
    إذا كنت تقوم بهذا التمرين خلال جلسة تدريب محلية، يمكنك تكوين pywiscat للاستعلام عن GDC المحلي عن طريق ضبط متغير البيئة `PYWISCAT_GDC_URL`:
...
لنحاول الاستعلام عن GDC باستخدام كلمة مفتاحية:
