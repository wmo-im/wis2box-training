...
- وزارة البيئة وتغير المناخ الكندية، خدمة الأرصاد الجوية الكندية: <https://wis2-gdc.weather.gc.ca>
- الإدارة الصينية للأرصاد الجوية: <https://gdc.wis.cma.cn>
- خدمة الأرصاد الجوية الألمانية: <https://wis2.dwd.de/gdc>

خلال جلسات التدريب المحلية، يتم إعداد كتالوج عالمي محلي للاكتشاف (GDC) للسماح للمشاركين بالاستعلام عن الكتالوج للبيانات الوصفية التي قاموا بنشرها من مثيلات wis2box الخاصة بهم. في هذه الحالة، سيقوم المدربون بتوفير رابط URL للكتالوج المحلي.
...
!!! note
    ...
    ...حيث `$USER` هو اسم المستخدم الخاص بك على الجهاز الافتراضي.
...
بشكل افتراضي، يتصل pywiscat بالكتالوج العالمي للاكتشاف (GDC) المستضاف من قبل وزارة البيئة وتغير المناخ الكندية (ECCC).

!!! note "تغيير رابط URL الخاص بـ GDC"
    إذا كنت تقوم بهذا التمرين خلال جلسة تدريب محلية، يمكنك تكوين pywiscat للاستعلام عن الكتالوج المحلي عن طريق ضبط متغير البيئة `PYWISCAT_GDC_URL`:
...
يمكنك البحث في الكتالوج عن جميع السجلات:
...
??? success "اضغط للكشف عن الإجابة"
    يعتمد عدد السجلات على الكتالوج الذي تقوم بالاستعلام منه. عند استخدام الكتالوج المحلي للتدريب، يجب أن ترى أن عدد السجلات يساوي عدد مجموعات البيانات التي تم إدخالها في الكتالوج خلال الجلسات العملية الأخرى.

لنحاول الاستعلام عن الكتالوج باستخدام كلمة مفتاحية:
...
للحصول على مزيد من التفاصيل حول نتيجة بحث معينة تهمك:
