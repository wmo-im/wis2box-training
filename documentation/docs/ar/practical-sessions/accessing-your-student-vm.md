...
!!! abstract "نتائج التعلم"
    ...
    - التحقق من أن لديك وصولًا إلى مواد التمارين لهذا التدريب على جهاز الطالب الافتراضي الخاص بك

## المقدمة

كجزء من ورش العمل التدريبية المحلية لـ WIS2، يمكنك الوصول إلى جهاز الطالب الافتراضي الشخصي الخاص بك على الشبكة التدريبية المحلية المسماة "WIS2-training".
...
!!! note
    ...
    تتطلب مواد التمارين الحزم الإضافية التالية من Python لتشغيلها:
    ...
    إذا كنت تستخدم جهاز الطالب الافتراضي المقدم خلال جلسات التدريب المحلية لـ WIS2، فسيتم تثبيت البرامج المطلوبة مسبقًا.
