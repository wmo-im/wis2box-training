...
!!! abstract "نتائج التعلم"
    ...
    - الوصول إلى الجهاز الافتراضي الخاص بك عبر SSH و WinSCP
    - التحقق من تثبيت البرامج المطلوبة للتمارين العملية
    - التحقق من الوصول إلى مواد التمارين لهذا التدريب على الجهاز الافتراضي الخاص بك

## المقدمة

كجزء من ورش العمل التدريبية المحلية لـ WIS2، يمكنك الوصول إلى الجهاز الافتراضي الشخصي الخاص بك على الشبكة التدريبية المحلية المسماة "WIS2-training".
...
!!! note
    ...
    بعد إنشاء الجهاز الافتراضي، تأكد من تثبيت python و docker و docker compose، كما هو موضح في [wis2box-software-dependencies](https://docs.wis2box.wis.wmo.int/en/latest/user/getting-started.html#software-dependencies).
    ...
    إذا كنت تستخدم الجهاز الافتراضي المقدم خلال جلسات التدريب المحلية لـ WIS2، فسيتم تثبيت البرامج المطلوبة مسبقًا.

## الاتصال بالجهاز الافتراضي الخاص بك على الشبكة التدريبية المحلية
...
لتتمكن من تشغيل wis2box، يجب أن يحتوي الجهاز الافتراضي الخاص بالطالب على Python و Docker و Docker Compose مثبتة مسبقًا.
