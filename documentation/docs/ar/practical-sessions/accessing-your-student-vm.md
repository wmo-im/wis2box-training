...
!!! abstract "الأهداف التعليمية"
    ...
    - الوصول إلى الجهاز الافتراضي الخاص بك باستخدام SSH وWinSCP
    - التحقق من تثبيت البرامج المطلوبة للتمارين العملية
    - التحقق من أنك تمتلك مواد التمارين لهذا التدريب على الجهاز الافتراضي الخاص بك
...
!!! note
    ...
    يمكن تنزيل أرشيف الإصدار الخاص بـ 'wis2box' المستخدم في هذا التدريب كالتالي:
    ...
    يمكن تنزيل مواد التمارين المستخدمة في هذا التدريب كالتالي:
    ...
    إذا كنت تستخدم الجهاز الافتراضي المقدم خلال جلسات تدريب WIS2 المحلية، فسيتم تثبيت البرامج المطلوبة مسبقًا.
...
!!! tip
    تواصل مع المدرب إذا لم تكن متأكدًا من اسم المضيف/اسم المستخدم أو واجهت مشكلات في الاتصال.
...
لكي تتمكن من تشغيل wis2box، يجب أن يحتوي الجهاز الافتراضي الخاص بالطالب على Python وDocker وDocker Compose مثبتة مسبقًا.
...
افتح WinSCP وانقر على "New Site". يمكنك إنشاء اتصال SCP جديد بجهازك الافتراضي كالتالي:
