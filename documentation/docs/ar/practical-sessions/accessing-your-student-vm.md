...
!!! abstract "نتائج التعلم"
    ...
    - التحقق من أنك تمتلك مواد التمارين لهذا التدريب على جهاز الطالب الافتراضي الخاص بك

## المقدمة

كجزء من ورش عمل تدريبية محلية لـ WIS2، يمكنك الوصول إلى جهاز الطالب الافتراضي الشخصي الخاص بك على الشبكة التدريبية المحلية المسماة "WIS2-training".
...
!!! note
    ...
    إذا كنت ترغب في تنفيذ هذا التدريب خارج جلسة تدريبية محلية، يمكنك توفير جهاز افتراضي خاص بك باستخدام أي مزود خدمة سحابية، على سبيل المثال:
    ...
    بعد إنشاء الجهاز الافتراضي الخاص بك، تأكد من تثبيت python، docker و docker compose، كما هو موضح في [wis2box-software-dependencies](https://docs.wis2box.wis.wmo.int/en/latest/user/getting-started.html#software-dependencies).
...
!!! tip
    اتصل بالمدرب إذا كنت غير متأكد من اسم المضيف/اسم المستخدم أو واجهت مشكلات في الاتصال.
...
لتتمكن من تشغيل wis2box، يجب أن يحتوي جهاز الطالب الافتراضي على Python، Docker و Docker Compose مثبتة مسبقًا.
...
لاختبار أن المستخدم الخاص بك يمكنه تشغيل docker hello-world، قم بتنفيذ الأمر التالي:
```bash
...
تحقق من أنك ترى ما يلي في الناتج:
...
يجب أن تكون الآن قادرًا على رؤية محتويات دليل المنزل على جهاز الطالب الافتراضي الخاص بك والوصول إلى ملفاتك.
