...
كجزء من ورش العمل التدريبية المحلية لـWIS2، يمكنك الوصول إلى الجهاز الافتراضي الخاص بك على الشبكة المحلية للتدريب المسماة "WIS2-training".
...
!!! note
    ...
    الحزم الإضافية التالية لـPython مطلوبة لتشغيل مواد التمارين:
...
لتتمكن من تشغيل wis2box، يجب أن يحتوي الجهاز الافتراضي الخاص بك على Python وDocker وDocker Compose مثبتة مسبقًا.
