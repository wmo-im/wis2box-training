...
!!! note
    ...
    إذا كنت ترغب في تشغيل هذا التدريب خارج جلسة تدريب محلية، يمكنك توفير جهاز افتراضي خاص بك باستخدام أي مزود خدمة سحابية، على سبيل المثال:
    ...
    تتطلب مواد التمارين الإضافية تثبيت حزم Python التالية:
