...
!!! abstract "نتائج التعلم"
    ...
    - التحقق من توفر مواد التمارين لهذا التدريب على جهاز الطالب الافتراضي الخاص بك
...
!!! note
    ...
    إذا كنت ترغب في إجراء هذا التدريب خارج جلسة تدريبية محلية، يمكنك توفير جهاز افتراضي خاص بك باستخدام أي مزود خدمة سحابية، على سبيل المثال:
