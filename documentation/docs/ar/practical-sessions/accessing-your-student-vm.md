...
كجزء من ورش العمل التدريبية المحلية لـWIS2، يمكنك الوصول إلى جهاز الطالب الافتراضي الخاص بك على الشبكة التدريبية المحلية المسماة "WIS2-training".
...
!!! note
    ...
    إذا كنت ترغب في تنفيذ هذا التدريب خارج جلسة تدريب محلية، يمكنك توفير جهاز افتراضي خاص بك باستخدام أي مزود خدمة سحابية، على سبيل المثال:
    ...
    بعد إنشاء جهازك الافتراضي، تأكد من تثبيت python وdocker وdocker compose، كما هو موضح في [wis2box-software-dependencies](https://docs.wis2box.wis.wmo.int/en/latest/user/getting-started.html#software-dependencies).
