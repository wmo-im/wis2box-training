...
!!! note
    ...
    إذا كنت ترغب في إجراء هذا التدريب خارج جلسة تدريبية محلية، يمكنك توفير جهاز افتراضي خاص بك باستخدام أي مزود خدمات سحابية، على سبيل المثال:
...
!!! tip
    تواصل مع المدرب إذا لم تكن متأكدًا من اسم المضيف/اسم المستخدم أو إذا واجهت مشاكل في الاتصال.
