...
!!! abstract "نتائج التعلم"
    ...
    - التحقق من وصولك إلى مواد التمارين لهذا التدريب على جهاز الطالب الافتراضي المحلي الخاص بك

## المقدمة

كجزء من ورشة عمل تدريبية محلية لـ WIS2، يمكنك الوصول إلى جهاز الطالب الافتراضي الشخصي الخاص بك على الشبكة التدريبية المحلية المسماة "WIS2-training".
...
!!! note
    ...
    إذا كنت ترغب في تشغيل هذا التدريب خارج جلسة تدريبية محلية، يمكنك توفير جهاز افتراضي خاص بك باستخدام أي مزود خدمة سحابية، على سبيل المثال:
