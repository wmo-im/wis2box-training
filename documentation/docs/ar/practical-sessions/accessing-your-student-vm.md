...
!!! note
    ...
    إذا كنت ترغب في تنفيذ هذا التدريب خارج جلسة تدريبية محلية، يمكنك توفير جهاز افتراضي خاص بك باستخدام أي مزود خدمة سحابية، مثل:
...
!!! tip
    تواصل مع المدرب إذا لم تكن متأكدًا من اسم المضيف أو اسم المستخدم أو إذا واجهت مشاكل في الاتصال.
