...
!!! note
    ...
    如果你希望在本地培训课程之外运行此培训，可以使用任何云服务提供商提供的实例，例如：
    ...
    你可以随时在 [https://github.com/World-Meteorological-Organization/wis2box/releases](https://github.com/World-Meteorological-Organization/wis2box-release/releases) 找到最新的 'wis2box-setup' 发行版。
...
为了确保你的用户可以运行 Docker 命令，你的用户已被添加到 `docker` 组中。

测试你的用户是否可以运行 Docker 的 hello-world 命令，执行以下命令：
```bash
