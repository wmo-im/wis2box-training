...
!!! note
    ...
    如果您希望在本地培训课程之外运行本次培训，您可以通过任何云服务提供商提供自己的实例，例如：
    ...
    本次培训使用的 wis2box 版本归档文件可通过以下方式下载：
...
将您的电脑连接到 WIS2 培训期间房间内广播的本地 Wi-Fi，具体操作请按照培训师提供的说明进行。
