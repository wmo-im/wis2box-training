...
!!! note
    ...
    本次培训使用的 wis2box 版本归档文件可以通过以下方式下载：
...
测试您的用户是否可以运行 Docker 的 hello-world 命令，请执行以下命令：
```bash
...
打开 WinSCP 并点击 "New Site"。您可以创建一个新的 SCP 连接，具体设置如下：

<img alt="winscp-student-vm-scp.png" src="/../assets/img/winscp-student-vm-scp.png" width="400">

点击 'Save' 然后点击 'Login' 连接到您的虚拟机。

现在您应该可以看到学生虚拟机主目录的内容，并访问您的文件。
