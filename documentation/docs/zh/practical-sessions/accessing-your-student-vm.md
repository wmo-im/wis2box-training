...
!!! note
    ...
    如果您希望在本地培训课程之外运行本次培训，您可以使用任何云服务提供商提供自己的实例，例如：
    ...
    本次培训使用的 wis2box 发行版归档文件可通过以下方式下载：
    ...
    如果您使用的是本地 WIS2 培训课程期间提供的学生虚拟机，则所需的软件已经安装。

## 在本地培训网络上连接到您的学生虚拟机

根据培训师提供的说明，将您的电脑连接到 WIS2 培训期间房间内广播的本地 Wi-Fi。

使用 SSH 客户端连接到您的学生虚拟机，使用以下信息：
...
如果您的本地电脑安装了 WinSCP，您可以使用它连接到您的学生虚拟机，检查主目录内容，并在虚拟机和本地电脑之间上传或下载文件。

WinSCP 不是培训所必需的，但如果您希望使用本地电脑上的文本编辑器编辑虚拟机上的文件，它可能会很有用。

以下是如何使用 WinSCP 连接到您的学生虚拟机：
