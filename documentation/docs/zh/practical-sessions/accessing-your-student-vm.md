...
!!! note
    ...
    请选择 Ubuntu Server 22.0.4 LTS 作为操作系统。
    ...
    如果你使用的是本地 WIS2 培训课程中提供的学生虚拟机，则所需软件已预先安装。
...
测试你的用户是否能够运行 Docker hello-world，请执行以下命令：
```bash
...
如果你的本地电脑安装了 WinSCP，你可以使用它连接到学生虚拟机，检查主目录内容，并在虚拟机与本地电脑之间上传或下载文件。
