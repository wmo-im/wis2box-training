...
!!! note
    ...
    创建虚拟机后，确保你已安装 python、docker 和 docker compose，具体说明请参考 [wis2box-software-dependencies](https://docs.wis2box.wis.wmo.int/en/latest/user/getting-started.html#software-dependencies)。
    ...
    如果你使用的是本地 WIS2 培训课程中提供的学生虚拟机，所需的软件将已经安装。
...
测试你的用户是否可以运行 Docker hello-world，执行以下命令：
```bash
docker run hello-world
```

这将拉取 hello-world 镜像并运行一个容器，打印一条消息。
