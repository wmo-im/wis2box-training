...
进入新创建的目录，点击 `Upload`，找到您之前下载到本地计算机的 [geps_202508180000.grib2](../sample-data/geps_202508180000.grib2)，并将此文件上传到 wis2box-incoming 存储桶。
...
!!! question "问题"
    ...
    您是否能够成功上传到 wis2box-incoming 存储桶？
...
检查 Grafana 仪表板和 MQTT Explorer，查看测试数据是否成功被摄取并发布。如果看到任何错误，请尝试解决。
