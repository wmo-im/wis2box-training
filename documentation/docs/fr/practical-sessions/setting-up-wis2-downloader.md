...
Téléchargez la dernière archive tarball depuis GitHub et extrayez-la sur votre VM étudiant :
...
!!! question "Examiner la configuration de WIS2 Downloader"
    ...
    Quel port est utilisé par l'API du gestionnaire d'abonnements ?
...
Pour la liste complète des points d'accès disponibles (liste, récupération, mise à jour des abonnements et plus), consultez la documentation interactive Swagger disponible à `localhost:5002/swagger`.
