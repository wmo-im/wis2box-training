...
Le modèle 'AWS' fournit un modèle de mappage pour convertir les données CSV en séquences BUFR 301150, 307096, afin de répondre aux exigences minimales de GBON.
