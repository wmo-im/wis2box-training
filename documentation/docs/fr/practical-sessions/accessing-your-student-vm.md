...
Dans le cadre de l'atelier de formation WIS2 local, vous pouvez accéder à votre VM étudiant personnelle sur le réseau de formation local nommé "WIS2-training".
