...
Si vous avez installé WinSCP sur votre PC local, vous pouvez l'utiliser pour vous connecter à votre VM étudiant et inspecter le contenu de votre répertoire personnel, ainsi que pour télécharger ou envoyer des fichiers entre votre VM et votre PC local. 
...
Vous devriez maintenant voir le contenu du répertoire personnel sur votre VM étudiant et accéder à vos fichiers.
