...
![Notebook Jupyter prévision d'ensemble globale GRIB2](../assets/img/jupyter-grib2-global-ensemble-prediction.png)
...
![Prévision d'ensemble globale température](../assets/img/grib2-global-ensemble-prediction-map.png)
...
![Notebook Jupyter anomalies de température mensuelles](../assets/img/jupyter-netcdf4-monthly-temperature-anomalies.png)
...
- [Integrated Data Viewer (IDV)](https://www.unidata.ucar.edu/software/idv/) - un framework logiciel gratuit basé sur Java pour analyser et visualiser les données géoscientifiques, y compris les formats GRIB et NetCDF
