...
Pour des informations sur la création et l'utilisation de modèles de mappage BUFR personnalisés, consultez le prochain exercice pratique [csv2bufr-templates](./csv2bufr-templates.md).
