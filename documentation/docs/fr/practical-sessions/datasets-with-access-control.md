...
Assurez-vous d'avoir un accès SSH à votre machine virtuelle étudiante et que votre instance wis2box est en cours d'exécution.
...
Soumettez le jeu de données, en utilisant le jeton d'authentification créé précédemment, et vérifiez que le nouveau jeu de données est créé dans le wis2box-webapp.
