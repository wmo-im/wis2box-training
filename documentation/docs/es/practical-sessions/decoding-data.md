...
!!! abstract "¡Resultados de aprendizaje!"
    ...
    - ejecutar los notebooks de ejemplo de Jupyter para decodificar datos en los formatos GRIB2, NetCDF y BUFR
...
- GRIB2 que contiene datos de una Predicción Global por Conjunto realizada por el Sistema Global Regional de Asimilación y Predicción (GRAPES) del CMA
...
- `-v ~/wis2-downloads:/root/downloads` monta el directorio `~/wis2-downloads` en tu VM en `/root/downloads` dentro del contenedor. Aquí es donde se almacenan los datos descargados desde WIS2 después de seguir las instrucciones de la sesión práctica anterior sobre el WIS2 Downloader.
- `-p 8888:8888` asigna el puerto 8888 de tu VM al puerto 8888 del contenedor. Esto hace que el servidor de notebook de Jupyter sea accesible desde tu navegador web en `http://YOUR-HOST:8888`
...
!!! note "Sobre la imagen demo-decode-eccodes-jupyter"
    ...
    La imagen `demo-decode-eccodes-jupyter` fue desarrollada para este entrenamiento y utiliza una imagen base que incluye la biblioteca ecCodes, además de agregar un servidor de notebook de Jupyter y paquetes de Python para análisis y visualización de datos.

    El código fuente de esta imagen, incluidos los notebooks de ejemplo, se encuentra en [wmo-im/demo-decode-eccodes-jupyter](https://github.com/wmo-im/demo-decode-eccodes-jupyter).
...
![Trayectoria de ciclones tropicales en Jupyter](../assets/img/jupyter-tropical-cyclone-track.png)
...
!!! note "Decodificación de datos NetCDF"
    ...
    NetCDF es un formato flexible que, en este ejemplo, reportó los valores para la variable 'anomaly' reportados a lo largo de las dimensiones 'lat', 'lon'. Diferentes conjuntos de datos NetCDF pueden utilizar diferentes nombres de variables y dimensiones.

## Uso de otras herramientas para ver y decodificar formatos binarios de la OMM
...
También puedes utilizar otras herramientas para decodificar y visualizar formatos de código impulsados por tablas de la OMM sin necesidad de escribir software, como:
