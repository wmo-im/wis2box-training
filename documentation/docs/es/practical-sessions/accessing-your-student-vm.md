...
Como parte de las sesiones de entrenamiento de wis2box realizadas localmente, puedes acceder a tu VM de estudiante personal en la red local de entrenamiento denominada "WIS2-training".
...
!!! note
    ...
    El archivo de lanzamiento para wis2box utilizado en este entrenamiento se puede descargar de la siguiente manera:
    ...
    Siempre puedes encontrar el último archivo 'wis2box-setup' en [https://github.com/World-Meteorological-Organization/wis2box/releases](https://github.com/World-Meteorological-Organization/wis2box-release/releases).

    Los materiales de ejercicio utilizados en este entrenamiento se pueden descargar de la siguiente manera:
    ...
    Si estás utilizando la VM de estudiante proporcionada durante las sesiones locales de entrenamiento WIS2, el software necesario ya estará instalado.
...
Inspecciona los contenidos de tu directorio home; estos son los materiales utilizados como parte del entrenamiento y las sesiones prácticas.
...
WinSCP no es necesario para el entrenamiento, pero puede ser útil si deseas editar archivos en tu VM usando un editor de texto en tu PC local.
