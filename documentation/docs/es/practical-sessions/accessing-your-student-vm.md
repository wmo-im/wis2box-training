...
!!! abstract "Resultados de aprendizaje"
    ...
    - verificar que tienes acceso al material de los ejercicios para esta capacitación en tu VM de estudiante local

## Introducción

Como parte del taller de capacitación local de WIS2, puedes acceder a tu VM de estudiante personal en la red de capacitación local llamada "WIS2-training".
...
!!! note
    ...
    Si deseas realizar esta capacitación fuera de una sesión de entrenamiento local, puedes proporcionar tu propia instancia utilizando cualquier proveedor de la nube, por ejemplo:
    ...
    Los siguientes paquetes adicionales de Python son necesarios para ejecutar el material de los ejercicios:
...
## Inspeccionar el material de los ejercicios
