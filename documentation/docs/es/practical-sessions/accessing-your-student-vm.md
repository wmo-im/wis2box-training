...
!!! abstract "Resultados de aprendizaje"
    ...
    - verificar que tienes acceso al material de ejercicios para esta capacitación en tu VM de estudiante local

## Introducción

Como parte de los talleres de capacitación de WIS2 realizados localmente, puedes acceder a tu VM de estudiante personal en la red de capacitación local llamada "WIS2-training".
...
!!! note
    ...
    - Azure (Microsoft) Máquina Virtual de Azure `standard_b2s`
    ...
    Los siguientes paquetes adicionales de Python son necesarios para ejecutar el material de ejercicios:
...
!!! tip
    Contacta a un instructor si no estás seguro del nombre del host/nombre de usuario o si tienes problemas para conectarte.
...
## Inspecciona el material de ejercicios
