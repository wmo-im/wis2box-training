...
Como parte del taller de capacitación local de WIS2, puedes acceder a tu VM de estudiante personal en la red de entrenamiento local llamada "WIS2-training".
...
Aquí tienes cómo puedes conectarte a tu VM de estudiante utilizando WinSCP:
