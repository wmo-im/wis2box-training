...
Continúa completando los campos requeridos para las Propiedades Espaciales y la Información de Contacto, y utiliza 'Validate form' para verificar si hay errores.
...
Revisa MQTT Explorer para confirmar que recibes el Mensaje de Notificación WIS2 anunciando el nuevo registro de Metadatos de Descubrimiento en el tema `origin/a/wis2/<your-centre-id>/metadata`.

## Revisa tu nuevo conjunto de datos en la wis2box-api

Consulta la lista de conjuntos de datos en la wis2box-api abriendo la URL `WIS2BOX_URL/oapi/collections/discovery-metadata/items` en tu navegador web, reemplazando `WIS2BOX_URL` con la URL de tu instancia de wis2box.
...
## Agregar un archivo de licencia personalizado a tu instancia de wis2box (opcional)
...
Una vez que hayas iniciado sesión en la Consola MinIO, puedes subir el archivo de licencia en la ruta base del bucket **wis2box-public** utilizando el botón “Upload”:
